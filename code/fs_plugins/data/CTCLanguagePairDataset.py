...
class LanguagePairDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        ...
        remove_bos_eos_tgt = getattr(self, "remove_bos_eos_tgt", False)
...
class CTCLanguagePairDatasetNoBosEos(LanguagePairDataset):
    def __init__(self, trg_length_multiplier=4, remove_bos_eos_tgt=False, *args, **kwargs, ):
        super().__init__(*args, **kwargs)
        self.trg_length_multiplier = trg_length_multiplier
        self.remove_bos_eos_tgt = remove_bos_eos_tgt
    ...
    def filter_indices_by_size(self, indices, max_sizes):
        ...
        indices = indices[self.src_sizes[indices] * self.trg_length_multiplier > self.tgt_sizes[indices]]
