...
It implements the beamsearch algorithm for DA-Transformer. It is modified based on the [kenlm](https://github.com/kpu/kenlm).
...
We use a model with ~200M for En-De and ~300M for Zh-En
