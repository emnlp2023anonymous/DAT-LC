...
from fs_plugins.modules.diffusion.rspace import SpacedDiffusion, space_timesteps
import fs_plugins.modules.diffusion.gaussian_diffusion as gd
from fs_plugins.modules.diffusion.resample import UniformSampler
...
@register_task("generation_diff", dataclass=TranslationLevenshteinConfig)
class GenerationDiffTask(TranslationTask):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        betas = gd.get_named_beta_schedule('sqrt', self.diff_steps)
        
        self.diffusion = SpacedDiffusion(
            use_timesteps=space_timesteps(self.diff_steps, [self.diff_steps]),
            betas=betas,
            model_mean_type=(
    ...
    def build_generator(self, models, args, **unused):
        ...
        from fs_plugins.others.diffusion_generator import DiffusionGenerator
        ...
        generator = DiffusionGenerator(
            ...
            diffusion_module=self.diffusion,
