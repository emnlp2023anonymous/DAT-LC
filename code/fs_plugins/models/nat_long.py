...
from fairseq.models.nat.nonautoregressive_transformer import FairseqNATDecoder, FairseqNATModel, ensemble_decoder
...
class NATransformerDecoder(FairseqNATDecoder):
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.embed_length = Embedding(2048, self.encoder_embed_dim, None)
    ...
    def forward_length_prediction(self, length_out, encoder_out, tgt_tokens=None):
        ...
        if tgt_tokens is not None:
            ...
            if self.pred_length_offset:
                length_tgt = tgt_lengs - src_lengs + 1024
            else:
            ...
            if self.pred_length_offset:
                length_tgt = pred_lengs - 1024 + src_lengs
            else:
